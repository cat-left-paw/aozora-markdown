...
[Aozora MarkdownのWeb版](https://cat-left-paw.github.io/aozora-markdown/)をブラウザで開いて使えます。ファイルはブラウザ内で処理し、変換のために外部へ送信しません。

## ローカルでWeb版を使う

Web版のローカル起動にはNode.js 24が必要です。全検証には、PATHから呼べるCPython 3.12.8とGoogle Chromeも必要です。
...
表示された `http://127.0.0.1:4173/` をChromeで開きます。`file://` での起動には対応しません。
